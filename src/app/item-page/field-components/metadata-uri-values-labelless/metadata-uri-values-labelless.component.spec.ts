...
import { MetadataUriValuesLabellessComponent } from './metadata-uri-values-labelless.component';
import { isNotEmpty } from '../../../shared/empty.util';
import { MetadataValue } from '../../../core/shared/metadata.models';
import { APP_CONFIG } from '../../../../config/app-config.interface';
import { environment } from '../../../../environments/environment';

let comp: MetadataUriValuesLabellessComponent;
let fixture: ComponentFixture<MetadataUriValuesLabellessComponent>;
...
describe('MetadataUriValuesLabellessComponent', () => {
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [MetadataUriValuesLabellessComponent],
      schemas: [NO_ERRORS_SCHEMA]
    }).overrideComponent(MetadataUriValuesLabellessComponent, {
      set: {changeDetection: ChangeDetectionStrategy.Default}
    }).compileComponents();
  }));

  beforeEach(waitForAsync(() => {
    fixture = TestBed.createComponent(MetadataUriValuesLabellessComponent);
