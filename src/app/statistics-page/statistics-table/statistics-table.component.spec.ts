...
describe('StatisticsTableComponent', () => {
  ...
  describe('when the storage report has data', () => {
    ...
    it ('should display a table with the correct data', () => {
      ...
      expect(de.query(By.css('.table-responsive'))).toBeTruthy();

      expect(de.query(By.css('.views-header')).nativeElement.innerText)
        .toEqual('views');
      expect(de.query(By.css('.downloads-header')).nativeElement.innerText)
        .toEqual('downloads');

      expect(de.query(By.css('.item_1-views-data')).nativeElement.innerText)
        .toEqual('7');
      expect(de.query(By.css('.item_1-downloads-data')).nativeElement.innerText)
        .toEqual('4');
      expect(de.query(By.css('.item_2-views-data')).nativeElement.innerText)
        .toEqual('8');
      expect(de.query(By.css('.item_2-downloads-data')).nativeElement.innerText)
        .toEqual('8');
    });
  });
});
